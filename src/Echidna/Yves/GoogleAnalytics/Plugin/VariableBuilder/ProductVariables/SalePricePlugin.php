...
namespace Echidna\Yves\GoogleAnalytics\Plugin\VariableBuilder\ProductVariables;
...
class SalePricePlugin extends AbstractPlugin implements ProductVariableBuilderPluginInterface
{
    ...
    /**
     * @var \Echidna\Yves\GoogleAnalytics\GoogleAnalyticsConfig
     */
    protected $config;
    ...
    public function __construct()
    {
        ...
        $this->config = $this->getFactory()->getGoogleAnalyticsConfig();
    }
