...
namespace Echidna\Shared\GoogleAnalytics;

interface EchidnaEcommerceConstants
{
    ...
    //TODO: Add/change with the referring payment type -cc/wallet payone/paypal
    public const PAYMENT_METHOD_PAYPAL_SELECTION = 'EWallet';
    public const PAYMENT_METHOD_CREDITCARD_NAME = 'creditcard';
    public const PAYMENT_METHOD_CREDITCARD_SELECTION = 'CreditCard';
