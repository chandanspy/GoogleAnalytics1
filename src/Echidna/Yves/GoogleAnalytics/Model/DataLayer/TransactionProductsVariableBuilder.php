...
{
    /**
     * @var array|\Echidna\Yves\GoogleAnalytics\Plugin\VariableBuilder\TransactionProductVariables\TransactionProductVariableBuilderPluginInterface[]
     */
    protected $plugins;
    ...
    /**
     * @var \Echidna\Yves\GoogleAnalytics\Dependency\Client\GoogleAnalyticsToProductImageStorageClientInterface
     */
     ...
     * @param \Echidna\Yves\GoogleAnalytics\Dependency\Client\GoogleAnalyticsToProductImageStorageClientInterface $productImageStorageClient
     * @param \Echidna\Yves\GoogleAnalytics\Plugin\VariableBuilder\TransactionProductVariables\TransactionProductVariableBuilderPluginInterface[] $plugins
     * @param string $locale
     */
    public function __construct(
        MoneyPluginInterface $moneyPlugin,
        GoogleAnalyticsToProductStorageClientInterface $storageClient,
        GoogleAnalyticsToProductImageStorageClientInterface $productImageStorageClient,
        array $plugins,
        string $locale
    ) {
    ...
    {
        return [
            GoogleAnalyticsConstants::TRANSACTION_PRODUCT_ID => $itemTransfer->getIdProductAbstract(),
            GoogleAnalyticsConstants::TRANSACTION_PRODUCT_SKU => $itemTransfer->getSku(),
            GoogleAnalyticsConstants::TRANSACTION_PRODUCT_PRICE => $this->moneyPlugin->convertIntegerToDecimal($itemTransfer->getUnitPrice()),
            GoogleAnalyticsConstants::TRANSACTION_PRODUCT_PRICE_EXCLUDING_TAX => $this->getPriceExcludingTax($itemTransfer),
            GoogleAnalyticsConstants::TRANSACTION_PRODUCT_TAX => $this->moneyPlugin->convertIntegerToDecimal($itemTransfer->getUnitTaxAmount()),
            GoogleAnalyticsConstants::TRANSACTION_PRODUCT_TAX_RATE => $itemTransfer->getTaxRate(),
        ];
    }
