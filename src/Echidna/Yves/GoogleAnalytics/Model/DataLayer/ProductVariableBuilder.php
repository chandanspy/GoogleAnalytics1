...
use Echidna\Client\TaxProductConnector\TaxProductConnectorClient;
use Echidna\Shared\GoogleAnalytics\GoogleAnalyticsConstants;
use Generated\Shared\Transfer\GoogleAnalyticsProductDetailTransfer;
...
class ProductVariableBuilder
{
    ...
    /**
     * @var \Echidna\Client\TaxProductConnector\TaxProductConnectorClient
     */
    protected $taxProductConnectorClient;

    /**
     * @var array|\Echidna\Yves\GoogleAnalytics\Plugin\VariableBuilder\VariableBuilderPluginInterface[]
     */
    protected $productVariableBuilderPlugins;

    /**
     * @param \Spryker\Shared\Money\Dependency\Plugin\MoneyPluginInterface $moneyPlugin
     * @param \Echidna\Client\TaxProductConnector\TaxProductConnectorClient $taxProductConnectorClient
     * @param \Echidna\Yves\GoogleAnalytics\Plugin\VariableBuilder\ProductVariables\ProductVariableBuilderPluginInterface[] $productVariableBuilderPlugins
     */
    ...
    public function getVariables(ProductAbstractTransfer $product): array
    {
        ...
        $GoogleAnalyticsProductDetailTransfer = (new GoogleAnalyticsProductDetailTransfer())
        ...
        return $this->executePlugins($product, $GoogleAnalyticsProductDetailTransfer->toArray(true, true));
    }
