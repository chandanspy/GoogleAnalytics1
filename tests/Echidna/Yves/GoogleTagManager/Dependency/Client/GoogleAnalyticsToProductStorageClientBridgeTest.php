...
class GoogleAnalyticsToProductStorageClientBridgeTest extends Unit
{
    /**
     * @var \Echidna\Yves\GoogleAnalytics\Dependency\Client\GoogleAnalyticsToProductStorageClientBridge
     */
    protected $bridge;
    ...
    protected function _before()
    {
        ...
        $this->bridge = new GoogleAnalyticsToProductStorageClientBridge($this->productStorageClientMock);
    }
